...
import { ShieldCheck, Clock, Calculator, Wallet, CalendarCheck, List, X } from "lucide-react"

export const sections = [
  { id: "eligibility", label: "תנאי זכאות", icon: ShieldCheck },
  { id: "hours-calculation", label: "חישוב היקף שעות", icon: Clock },
  { id: "amount-calculation", label: "חישוב גובה דמי השיקום", icon: Calculator },
  { id: "payment-schedule", label: "מתי משולמים?", icon: Wallet },
...
export function RehabTableOfContents() {
  return (
...
export function MobileRehabTableOfContents() {
