...
import { Users, ClipboardList, Building, FileText, CalendarCheck, List, X } from "lucide-react"

export const sections = [
  { id: "eligibility", label: "זכאות לשיעורי עזר", icon: Users },
  { id: "franchisee", label: "שירות דרך זכיין", icon: ClipboardList },
  { id: "learning-center", label: "דרך מרכז התמיכה", icon: Building },
  { id: "documents", label: "שליחת מסמכים", icon: FileText },
...
export function TutoringTableOfContents() {
  return (
...
export function MobileTutoringTableOfContents() {
