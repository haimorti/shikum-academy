...
import { Train, Car, AlertTriangle, List, X } from "lucide-react"

export const sections = [
  { id: "public-transport", label: "תחבורה ציבורית", icon: Train },
  { id: "special-transport", label: "הסעה מיוחדת", icon: Car },
  { id: "important-note", label: "חשוב לזכור", icon: AlertTriangle },
]
