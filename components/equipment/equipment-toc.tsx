...
import { Coins, Laptop, FileText, Clock, CalendarCheck, List, X } from "lucide-react"

export const sections = [
  { id: "annual-grant", label: "מענק שנתי", icon: Coins },
  { id: "additional-equipment", label: "ציוד לימודי נוסף", icon: Laptop },
  { id: "grant-amount", label: "גובה הסיוע לציוד נוסף", icon: Coins },
  { id: "request-receipt", label: "הגשת בקשה וקבלה", icon: FileText },
  { id: "reimbursement", label: "מתי אקבל את ההחזר?", icon: Clock },
...
export function EquipmentTableOfContents() {
  return (
...
export function MobileEquipmentTableOfContents() {
