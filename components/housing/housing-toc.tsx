...
import { CheckCircle2, Wallet, Building, Home, Sun, FileText, CalendarCheck, List, X } from "lucide-react"

export const sections = [
  { id: "eligibility", label: "תנאי זכאות", icon: CheckCircle2 },
  { id: "aid-amount", label: "גובה הסיוע", icon: Wallet },
  { id: "housing-ministry", label: "סיוע ממשרד השיכון", icon: Building },
  { id: "property-ownership", label: "בעלות על דירה", icon: Home },
  { id: "summer", label: "חופשת הקיץ", icon: Sun },
  { id: "how-to-claim", label: "איך לממש?", icon: FileText },
  { id: "semester-end", label: "סיום סמסטר", icon: CalendarCheck },
]
...
export function HousingTableOfContents() {
  return (
...
export function MobileHousingTableOfContents() {
